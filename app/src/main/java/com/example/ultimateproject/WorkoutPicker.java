    ...
    List<String> getWorkouts (String workouttypes){
        ...
        if (workouttypes.equals("Chest")){
            ...
            workout.add("Cable Flies");
                ...
                workout.add("Dumbbell Bench Press");
            else if (num ==7)
                workout.add("Incline Dumbbell Bench Press");
            else if (num ==8)
            ...
            if (num==1)
                ...
                workout.add("Dumbbell Overhead Extensions");
            else if (num ==4)
            ...
            if (num==1)
                ...
                workout.add("Dumbbell Overhead Press");
            else if (num ==4)
                ...
                workout.add("Single Arm Kettlebell/Dumbbell Push");
            else if (num ==9)
            ...
            if (num==1)
                ...
                workout.add("Seated Dumbbell Curls");
            else if (num ==8)
            ...
            if (num==1)
                ...
                workout.add("Dumbbell Incline Rows");
            else if (num ==10)
            ...
            if (num==1)
                ...
                workout.add("Dumbbell Sumo Squats");
            else if (num ==3)
